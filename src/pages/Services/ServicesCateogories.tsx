...
const AllCategories = () => {
  const categories = [
    ...
    { id: 5, title: "Web Development Training", image: Web },
    { id: 6, title: "Programming Tutorials", image: Program },
    { id: 7, title: "Learn HTML/CSS", image: HTML },
    { id: 8, title: "Software Testing", image: Testing },
  ];
