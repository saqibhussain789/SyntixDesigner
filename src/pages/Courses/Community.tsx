  ...
  const testimonials = [
    {
      ...
      feedback: "This platform has completely changed my career trajectory. Highly recommended!",
    },
    {
      id: 2,
      name: "Liam Chen",
    ...
    },
    {
      ...
      name: "Amara Patel",
      country: "India",
      feedback: "The support and resources available here are unmatched. Great experience!",
    },
  ];
