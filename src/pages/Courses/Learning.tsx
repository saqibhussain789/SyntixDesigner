  ...
  const paths = [
    {
      ...
      title: "Learn",
      description:
        "Discover new knowledge and skills from experts in various fields.",
    },
    {
      id: 2,
      title: "Explore",
      description:
        "Navigate through topics and find the best resources tailored for you.",
    },
    {
      id: 3,
      title: "Dream",
      description:
        "Turn your learning journey into a dream career with proper guidance.",
    },
  ];
