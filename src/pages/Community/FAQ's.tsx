...
const FAQSection = () => {
  ...
  return (
    <div className="py-16">
      <div className="max-w-7xl px-4 py-10 mx-auto bg-yellow-200 mt-5">
      <div className="max-w-7xl px-4 mx-auto text-left">
        <h2 className="text-4xl font-bold text-yellow-500">ASK A</h2>
        <h3 className="text-5xl font-extrabold text-gray-800">QUESTION</h3>
        ...
        <div className="grid gap-6 mt-10 md:grid-cols-2">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className={`p-6 bg-white rounded-lg shadow-lg transition duration-300 ${
